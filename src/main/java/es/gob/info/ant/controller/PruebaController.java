...
public class PruebaController {
	...
	public ResponseEntity<Slice<CacheMunicipiosDto>> listarMunicipios(@PageableDefault(page = 1, size = 10) Pageable pageable, @SortDefault(sort = "nombreRegistroEntidadesLocales", direction = Direction.ASC) Sort sort, @RequestParam(name = "codProvincia") Long codProvincia) {	
